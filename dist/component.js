...
define("shared/components/cluster-driver/driver-oke/component", ["exports", "shared/mixins/cluster-driver"], function (exports, _clusterDriver) {
  ...
  exports.default = Ember.Component.extend(_clusterDriver.default, {
    ...
    init: function init() {
      ...
      var config = get(this, 'cluster.civoEngineConfig');
    ...
    actions: {
      ...
      upgradeCluster: function upgradeCluster(cb) {
        ...
        var quantityPerSubnet = get(this, 'cluster.civoEngineConfig.quantityPerSubnet');
        var kubernetesVersion = get(this, 'cluster.civoEngineConfig.kubernetesVersion');

        if (!quantityPerSubnet) {
          errors.push(intl.t('clusterNew.civo.quantityPerSubnet.required'));
        } else {
          var maxNodeCount = get(this, 'cluster.civoEngineConfig.maxNodeCount');
    ...
    selectedRegion: computed('cluster.civoEngineConfig.region', function () {
      var region = get(this, 'cluster.civoEngineConfig.region');
      return region;
    }),
    ...
    selectedVCN: computed('cluster.civoEngineConfig.vcnId', function () {
      var vcnId = get(this, 'cluster.civoEngineConfig.vcnId');
    ...
    selectedSubnetAccess: computed('cluster.civoEngineConfig.subnetAccess', function () {
      var subnetAccess = get(this, 'cluster.civoEngineConfig.subnetAccess');
    ...
    selectednodeShape: computed('cluster.civoEngineConfig.nodeShape', function () {
      var nodeShape = get(this, 'cluster.civoEngineConfig.nodeShape');
    ...
    selectedImage: computed('cluster.civoEngineConfig.nodeImage', function () {
      var nodeImage = get(this, 'cluster.civoEngineConfig.nodeImage');
    ...
    selectedk8sVersion: computed('cluster.civoEngineConfig.kubernetesVersion', function () {
      var k8sVersion = get(this, 'cluster.civoEngineConfig.kubernetesVersion');
    ...
    validate: function validate() {
      ...
      var tenancyId = get(this, 'cluster.civoEngineConfig.tenancyId');

      if (!tenancyId.startsWith('ocid1.tenancy')) {
        errors.push('A valid tenancy OCID is required');
      }

      var compartmentId = get(this, 'cluster.civoEngineConfig.compartmentId');
      ...
      var userOcid = get(this, 'cluster.civoEngineConfig.userOcid');
